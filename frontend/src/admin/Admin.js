...
export function AdminRestaurantCreate() {
    ...
    useEffect(() => { if (ready && role !== 'admin') {
        window.location.hash = '/';
    } }, [ready, role]);
    async function submit() {
        const payload = { name: name.trim(), address: addr.trim() };
    ...
    return (_jsxs("div", { className: "page", children: [_jsx("h2", { children: "Th\u00EAm nh\u00E0 h\u00E0ng" }), _jsxs("div", { className: "card", children: [_jsxs("div", { className: "form-row", children: [_jsx("label", { children: "T\u00EAn" }), _jsx("input", { className: "input", placeholder: "T\u00EAn nh\u00E0 h\u00E0ng", value: name, onChange: e => setName(e.target.value) })] }), _jsxs("div", { className: "form-row", children: [_jsx("label", { children: "\u0110\u1ECBa ch\u1EC9" }), _jsx("input", { className: "input", placeholder: "\u0110\u1ECBa ch\u1EC9", value: addr, onChange: e => setAddr(e.target.value) })] }), _jsxs("div", { className: "form-row", style: { display: 'flex', gap: 8 }, children: [_jsxs("div", { style: { flex: 1 }, children: [_jsx("label", { children: "Lat" }), _jsx("input", { className: "input", placeholder: "10.77", value: lat, onChange: e => setLat(e.target.value) })] }), _jsxs("div", { style: { flex: 1 }, children: [_jsx("label", { children: "Lng" }), _jsx("input", { className: "input", placeholder: "106.69", value: lng, onChange: e => setLng(e.target.value) })] })] }), _jsxs("div", { style: { display: 'flex', gap: 8, marginTop: 8 }, children: [_jsx("button", { className: "btn", onClick: () => { window.location.hash = '#/admin'; }, children: "Quay l\u1EA1i" }), _jsx("button", { className: "btn primary", onClick: submit, children: "L\u01B0u" })] })] })] }));
}
