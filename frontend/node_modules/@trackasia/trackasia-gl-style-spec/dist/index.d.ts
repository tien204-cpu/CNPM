 ...
 * Below are the operations and their arguments, the arguments should be aligned with the style methods in trackasia-gl-js.
 */
 ...
 * Operations produced by the diff closely resemble the trackasia-gl-js API. Any
 ...
 *
 * @private
 * @param {Array} filter TrackAsia filter
...
/**
 * Validate a TrackAsia style against the style specification.
 ...
 * @example
 *   const validate = require('@trackasia/trackasia-gl-style-spec/').validateStyleMin;
...
/**
 * Format a TrackAsia Style.  Returns a stringified style with its keys
 ...
 *
 * @private
 * @param {Object} style a TrackAsia Style
 * @param {number} [space] space argument to pass to `JSON.stringify`
 * @returns {string} stringified formatted JSON
 * @example
 * var fs = require('fs');
 * var format = require('trackasia-gl-style-spec').format;
...
/**
 * Migrate a Mapbox/TrackAsia GL Style to the latest version.
 *
 * @param style - a TrackAsia Style
 * @returns a migrated style
 * @example
 * const fs = require('fs');
 * const migrate = require('@trackasia/trackasia-gl-style-spec').migrate;
