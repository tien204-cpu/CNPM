...
Filter expressions are used to target specific data in a layer. This library implements the semantics specified by the [TrackAsia GL JS spec](https://docs.track-asia.com/style-spec/).
...
``` javascript
var ff = require('@trackasia/trackasia-gl-style-spec').featureFilter;
