...
const countryCode = process.env.COUNTRY_CODE || 'VN';
const exampleName = process.argv[2];
const useLocalhost = (process.argv.length > 3) && (process.argv[3] === 'serve');
const examplePath = path.resolve('test', 'examples', countryCode);
...
async function createImage(exampleName) {
    ...
    if (useLocalhost) {
        ...
        await page.setContent(html.replaceAll('../../dist', `https://unpkg.com/trackasia-gl@${packageJson.version}/dist`));
    }
