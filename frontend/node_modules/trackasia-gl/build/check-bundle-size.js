...
const beforejs = fileSize('./before/trackasia-gl.js');
const beforecss = fileSize('./before/trackasia-gl.css');
const afterjs = fileSize('./after/trackasia-gl.js');
const aftercss = fileSize('./after/trackasia-gl.css');
...
| :--- | :---: | :---: | :---: |
| trackasia-gl.js | ${prettyBytes(beforejs.gzipped)} | ${prettyBytes(afterjs.gzipped)} | ${prettyBytes(afterjs.gzipped - beforejs.gzipped, { signed: true })} |
| trackasia-gl.css | ${prettyBytes(beforecss.gzipped)} | ${prettyBytes(aftercss.gzipped)} | ${prettyBytes(aftercss.gzipped - beforecss.gzipped, { signed: true })} |`);
