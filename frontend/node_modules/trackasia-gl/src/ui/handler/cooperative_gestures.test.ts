...
describe('CoopGesturesHandler', () => {
    ...
    test('Does not zoom on wheel if no key is down', async () => {
        ...
        map._renderTaskQueue.run();
        expect(map.getContainer().querySelector('.trackasiagl-cooperative-gesture-screen.trackasiagl-show')).toBeInstanceOf(HTMLDivElement);
        ...
        expect(map.getContainer().querySelector('.trackasiagl-cooperative-gesture-screen.trackasiagl-show')).toBeNull();
        map.remove();
    });
