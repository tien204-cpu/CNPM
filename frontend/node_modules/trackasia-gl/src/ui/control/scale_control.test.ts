...
describe('ScaleControl', () => {
    test('appears in bottom-left by default', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.trackasiagl-ctrl-bottom-left .trackasiagl-ctrl-scale')
        ).toHaveLength(1);
    });
    ...
    test('appears in the position specified by the position option', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.trackasiagl-ctrl-top-left .trackasiagl-ctrl-scale')
        ).toHaveLength(1);
    });
    ...
    test('should change unit of distance after calling setUnit', () => {
        ...
        const selector = '.trackasiagl-ctrl-bottom-left .trackasiagl-ctrl-scale';
