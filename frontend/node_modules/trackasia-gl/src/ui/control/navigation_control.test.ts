...
describe('NavigationControl', () => {
    test('appears in the top-right', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.trackasiagl-ctrl-top-right > .trackasiagl-ctrl')
        ).toHaveLength(1);
    });
    ...
    test('contains zoom in button', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.trackasiagl-ctrl-zoom-in')
        ).toHaveLength(1);
    });
    ...
    test('contains zoom out button', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.trackasiagl-ctrl-zoom-out')
        ).toHaveLength(1);
    });
    ...
    test('contains compass button', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.trackasiagl-ctrl-compass')
        ).toHaveLength(1);
    });
    ...
    test('compass button reset action', () => {
        ...
        const navButton = map.getContainer().querySelector('.trackasiagl-ctrl-compass');
