...
describe('FullscreenControl', () => {
    test('renders control', () => {
        ...
        expect(map.getContainer().querySelectorAll('.trackasiagl-ctrl-fullscreen')).toHaveLength(1);
    });
    ...
    test('uses pseudo fullscreen when fullscreen is not supported', () => {
        ...
        expect(mapContainer.classList.contains('trackasiagl-pseudo-fullscreen')).toBe(false);
        control._onClickFullscreen();
        expect(mapContainer.classList.contains('trackasiagl-pseudo-fullscreen')).toBe(true);
        control._onClickFullscreen();
        expect(mapContainer.classList.contains('trackasiagl-pseudo-fullscreen')).toBe(false);
    });
