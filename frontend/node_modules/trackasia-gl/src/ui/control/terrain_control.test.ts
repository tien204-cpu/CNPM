...
describe('TerrainControl', () => {
    test('appears in top-right by default', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.trackasiagl-ctrl-top-right .trackasiagl-ctrl-terrain')
        ).toHaveLength(1);
    });
    ...
    test('appears in the position specified by the position option', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.trackasiagl-ctrl-bottom-right .trackasiagl-ctrl-terrain')
        ).toHaveLength(1);
