...
import {type GeoJSONSourceSpecification, type LayerSpecification} from '@trackasia/trackasia-gl-style-spec';
    ...
    test('transformStyle should copy the source and the layer into next style', async () => {
        ...
        map.setStyle(createStyle(), {
            ...
            transformStyle: (prevStyle, nextStyle) => ({
                ...
                sources: {
                    ...nextStyle.sources,
                    trackasia: prevStyle.sources.trackasia
                },
                layers: [
                    ...nextStyle.layers,
                    prevStyle.layers[0]
        ...
        expect('trackasia' in loadedStyle.sources).toBeTruthy();
