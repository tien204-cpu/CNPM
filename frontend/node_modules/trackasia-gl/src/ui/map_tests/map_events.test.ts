...
import {type MapLayerEventType, type TrackAsiaEvent} from '../events';
...
describe('map events', () => {
    ...
    test('Map#on calls an event listener with no type arguments, defaulting to \'unknown\' originalEvent type', () => {
        ...
        const handler = {
            onMove: function onMove(_event: TrackAsiaEvent) {}
        };
    ...
    test('Map#once calls an event listener with no type arguments, defaulting to \'unknown\' originalEvent type', () => {
        ...
        const handler = {
            onMoveOnce: function onMoveOnce(_event: TrackAsiaEvent) {}
        };
